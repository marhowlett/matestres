...
<p class="blanco">Ofrecemos asesorías personalizadas en el área de matemáticas, 100% vivo, en línea, vía zoom.</p>
<a href="#"  class="btn"> <span>¡Me interesa!</span></a>
</div>
</div>
</section>
...
<div class="contenedor">
    ...
    <div class="center">
        <a href="#"  class="btn"> <span>¡Me interesa!</span></a></div>
...
<div class="grid">
    <div class="col fondo"></div>
     ...
     <p class="blanco"><span class="espe">2. </span> Realiza tu pago a través de nuestra tienda en línea.</p>
...
<div class="grid">
  <div class="col2"><div class="ban"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/logo.png" alt="Logo"><h3 class="amarillo">Básico</h3></div><div class="ban2"><p><b>¿Qué incluye?</b></p><ul><li>1 sesión de 2 horas, vía 
   ...
   vivo y resolución de dudas
   de matemáticas.</li></ul><p>¡Son 6 horas de clases personalizadas!</p></div><div class="ban3"><p><b>Perfecto si tienes varias dudas acerca del un tema de matemáticas.</b></p></div><div class="ban2"><div class="precio precio2"><p><b>Por tan solo <br><span>$1,349</span> MXN</b></p></div></div><a href=""><div class="ban4"><h3 class="amarillo">¡Comprar!</h3></div></a></div>
  ...
  <div class="col">
    ...
    <div class="tabs">
      ...
      <div class="tab">
        ...
        <div class="tab-content">
          Nosotros te apoyamos a que entiendas y aprendas los temas necesarios para que saques buenas calificaciones. Es recomendable que tengas asesorías de manera constante. La membrecía MateTres14 es la opción recomendada.
        </div>
      </div>
      <div class="tab">
      ...
      <div class="tab">
        ...
        <label class="tab-label" for="rd7"> Estoy inscrito en la membrecía mensual, me gustaría tener más horas a la semana. ¿Se pueden añadir a mi plan?</label>
        <div class="tab-content">
...
<span>55 28 55 42 62</span></p></div>
       ...
       <div class="grid">
           <div class="col1"><img class="so" src="<?php echo get_stylesheet_directory_uri(); ?>/img/reloj.png" alt="Logo"> </div>
            <div class="col2"><p class="blanco">Lu-Vi de 9:00 - 21:00
<span>Sáb-Dom: 9:00 - 17:00</span></p></div>
       ...
       <div class="grid">
           <div class="col1"><img class="so" src="<?php echo get_stylesheet_directory_uri(); ?>/img/wa.png" alt="Logo"> </div>
            <div class="col2"><p class="blanco wa">55 65 55 79 32</p></div>
       </div>
